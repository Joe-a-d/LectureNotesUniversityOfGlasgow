...
\include{intro}
\include{counting}
\include{rules_axioms}
\include{random_discrete}
\include{random_continuous}
...
\todo*{\url{https://socratic.org/questions/how-do-you-use-a-probability-mass-function-to-calculate-the-mean-and-variance-of}}
\todos
