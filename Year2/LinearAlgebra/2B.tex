...
\begin{itemize}
	\item []Algebraic Properties of Vector Addition
	   ...
	   %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% WEEK 2 %%%%%%%%%%%%%%%%%%
	    ...
	    \extra{Cheatsheet:}{ Does $V$ span $P$? }{
		...
		\vphantom{.} \\
			...
			\mymarginpar{\\ $dim(P)$ is the dimension of the vector space e.g. $dim(R^{3}) = 3$} 
			\mymarginpar{V can be represented by a matrix}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% WEEK4	  %%%%%%%%%%%%%%%%%%%%%%%%
		...
		\prop{}{$\mathop{row}{(A)} = \mathop{col}{(A^{T})}$}
